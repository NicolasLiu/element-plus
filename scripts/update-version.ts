...
async function main() {
  ...
  const elementPlus =
    pkgs['lkq-element-plus'] || pkgs['@lkq-element-plus/nightly']
  const eslintConfig = pkgs['@lkq-element-plus/eslint-config']
  const metadata = pkgs['@lkq-element-plus/metadata']
