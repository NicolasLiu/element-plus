...
import { useDeprecated, useLocale } from '@lkq-element-plus/hooks'
import { debugWarn } from '@lkq-element-plus/utils'
import { INPUT_EVENT, UPDATE_MODEL_EVENT } from '@lkq-element-plus/constants'
...
export const useCalendar = (
  ...
  // https://github.com/lkq-element-plus/lkq-element-plus/issues/3155
  ...
  useDeprecated(
    {
      ...
      scope: 'ElCalendar',
      version: '2.3.0',
      ref: 'https://lkq-element-plus.org/en-US/component/calendar.html#slots',
      type: 'Slot',
    },
