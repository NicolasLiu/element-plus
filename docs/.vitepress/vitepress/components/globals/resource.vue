...
const mirrorUrl = 'lkq-element-plus.gitee.io'
const isMirrorUrl = () => {
  if (!isClient) return
...
const resourceUrl = {
  ...
  gitee: {
    sketch:
      'https://gitee.com/lkq-element-plus/resources/raw/master/Element_Plus_Design_System_2022_1.0_Beta.zip',
    axure:
      'https://gitee.com/lkq-element-plus/resources/raw/master/Element_Components_v2.1.0.rplib',
  },
