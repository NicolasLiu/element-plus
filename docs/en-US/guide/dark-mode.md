...
import 'lkq-element-plus/theme-chalk/dark/css-vars.css'
```

> If you want an example, you can refer to [element-plus-vite-starter](https://github.com/lkq-element-plus/lkq-element-plus-vite-starter).
...
@forward 'lkq-element-plus/theme-chalk/src/dark/var.scss' with (
  $bg-color: (
    'page': #0a0a0a,
    '': #626aef,
    'overlay': #1d1e1f,
...
// import 'lkq-element-plus/theme-chalk/src/dark/css-vars.scss'
```
